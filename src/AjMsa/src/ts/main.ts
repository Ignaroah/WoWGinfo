$("#search-form-submit").click(() => {
    ...
    var guildMembersUrl =
        "https://us.api.battle.net/wow/guild/" +
            realm +
            "/" +
            guild +
 ...
 //           classesDic['dsdsd'] = 4;
            ...
            for (var i = 0; i < data.members.length; i++) {
               ...
               try {
                   ...
                   for (var j = 0; j < specCount.length; j++) { //Check for spec name
               ...
               for (var j = 0; j < classCount.length; j++) { //check c;ass
